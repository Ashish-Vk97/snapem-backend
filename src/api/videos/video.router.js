...
const { saveSosVideos ,getAllSosVideos, getAllSosVideosById,deleteSosVideos} = require('./video.controller');
...
router.get('/sos/folders/videos/:id',authenticateToken, getAllSosVideosById);
router.delete( "/delete",authenticateToken,deleteSosVideos);
